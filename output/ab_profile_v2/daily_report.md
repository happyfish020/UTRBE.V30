...
- smart warning tier (WATCH): none->none->none->none->warning->warning->warning->none->none->none
...
- 报告日期与应有交易日一致。
- 数据源明细：
  - lead5: latest=2026-02-23, 已覆盖当天
  - lead10: latest=2026-02-23, 已覆盖当天
  - market_features: latest=2026-02-23, 已覆盖当天
- 结论：关键数据源均已覆盖当天。